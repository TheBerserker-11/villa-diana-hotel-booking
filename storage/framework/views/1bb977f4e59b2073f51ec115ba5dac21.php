...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('img/logo/logo.png')); ?>">
    ...
    <div class="admin-main">
        ...
        <div class="admin-topbar">
            <div class="d-flex align-items-center gap-2 gap-sm-3 admin-topbar-start">
                ...
                <div class="min-w-0">
                    <h5 class="mb-0 text-truncate"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h5>
        ...
        <div class="admin-footer small text-muted">
            © <?php echo e(date('Y')); ?> Villa Diana Hotel
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\V18\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>