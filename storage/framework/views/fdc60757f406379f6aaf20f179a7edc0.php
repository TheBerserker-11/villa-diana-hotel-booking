                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="auth-right">
                                ...
                                <div class="stepper">
                                    <div class="step <?php echo e($isStep1 ? 'active' : ($isStep2 || $isStep3 ? 'done' : '')); ?>">
                                        <span class="dot"><?php echo e($isStep2 || $isStep3 ? '✓' : '1'); ?></span>
                                        <span>Email</span>
                                    </div>
                                    <span class="step-sep">→</span>
                                    <div class="step <?php echo e($isStep2 ? 'active' : ($isStep3 ? 'done' : '')); ?>">
                                        <span class="dot"><?php echo e($isStep3 ? '✓' : '2'); ?></span>
                                        <span>OTP</span>
                                    </div>
                                    <span class="step-sep">→</span>
                                    <div class="step <?php echo e($isStep3 ? 'active' : ''); ?>">
                                ...
                                <?php if($isStep1): ?>
                                    <a
                                        href="<?php echo e(route('auth.google.register', $redirect ? ['redirect' => $redirect] : [])); ?>"
                                    ...
                                    <form method="POST" action="<?php echo e(route('send.otp')); ?>" id="sendOtpForm">
                                        <?php echo csrf_field(); ?>
                                        <?php if($redirect): ?>
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('name', session('register_name') ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('email', session('register_email') ?? '')); ?>" required>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
                                            <div class="text-muted" style="font-size:.95rem;">
                                                ...
                                                <span class="fw-semibold" style="color:#0F172B;">
                                                    <?php echo e(session('register_email') ?? old('email') ?? 'your email'); ?>
                                            ...
                                            <span class="timer-pill">
                                                ...
                                                <span>
                                                    Expires:
                                                    <span id="otpTimer" data-remaining="<?php echo e($otpRemaining); ?>">--:--</span>
                                                </span>
                                            </span>
                                        </div>

                                        <form method="POST" action="<?php echo e(route('verify.otp')); ?>" class="mt-3" id="otpForm">
                                            <?php echo csrf_field(); ?>
                                            <?php if($redirect): ?>
                                                <input type="hidden" name="redirect" value="<?php echo e($redirect); ?>">
                                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('send.otp')); ?>" id="resendForm" class="d-none">
                                            <?php echo csrf_field(); ?>
                                            <?php if($redirect): ?>
                                                <input type="hidden" name="redirect" value="<?php echo e($redirect); ?>">
                                            <?php endif; ?>
                                            <input type="hidden" name="name" value="<?php echo e(session('register_name')); ?>">
                                            <input type="hidden" name="email" value="<?php echo e(session('register_email')); ?>">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="<?php echo e(route('login', $redirect ? ['redirect' => $redirect] : [])); ?>" class="btn btn-ghost w-100">
                                ...
                                <?php if($isStep3): ?>
                                    <form method="POST" action="<?php echo e(route('register.final')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <?php if($redirect): ?>
                                            <input type="hidden" name="redirect" value="<?php echo e($redirect); ?>">
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-floating position-relative mb-3">
                                            ...
                                            <input type="text" id="address" name="address" autocomplete="off"
                                                   class="form-control ps-5 <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-floating position-relative mb-2">
                                            ...
                                            <input type="password" id="password" name="password"
                                                   class="form-control ps-5 pe-5 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <p class="text-center mt-3 mb-0 auth-links">
                                    ...
                                    <a href="<?php echo e(route('login', $redirect ? ['redirect' => $redirect] : [])); ?>">Log In</a>
                                </p>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const isStep1 = <?php echo $isStep1 ? 'true' : 'false'; ?>;
    ...
    <?php if(session('otp_sent') && !session('otp_verified')): ?>
        ...
        // Resend cooldown
        let resendLeft = <?php echo e((int)($resendRemaining ?? 0)); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\V18\resources\views/auth/register.blade.php ENDPATH**/ ?>