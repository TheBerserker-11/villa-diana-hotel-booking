...
<section class="vd-booking-wrap">
    <div class="container">
        <div class="vd-booking-card wow fadeIn" data-wow-delay="0.1s">
            ...
            <form id="availabilityForm" method="GET" action="<?php echo e(route('rooms.index')); ?>" class="vd-booking-form">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <div class="invalid-feedback d-block js-feedback"><?php echo e($message); ?></div>
                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="vd-field vd-date">
                            ...
                            <input
                                ...
                                type="text"
                                id="check_in"
                                class="form-control vd-input <?php $__errorArgs = ['check_in'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(request()->query('check_in')); ?>"
                            >
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="vd-field vd-date">
                            ...
                            <input
                                ...
                                type="text"
                                id="check_out"
                                class="form-control vd-input <?php $__errorArgs = ['check_out'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Select date"
                                value="<?php echo e(request()->query('check_out')); ?>"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4 vd-guests-wrap">
                        ...
                        >
                            <span class="vd-guest-left">
                                ...
                                <span>
                                    <strong id="vdGuestTotal"><?php echo e($totalGuests); ?></strong> 
                                    <span id="vdGuestLabel">guest<?php echo e($totalGuests > 1 ? 's' : ''); ?></span>
                                </span>
                            </span>
                            ...
                            <div class="vd-guest-panel">
                                ...
                                <div class="vd-guest-row">
                                    ...
                                    <div class="input-group guest-counter vd-counter" data-type="adult">
                                        ...
                                        <input id="vdAdults" type="number" name="adults" class="vd-counter-input" value="<?php echo e(request()->query('adults', 1)); ?>" min="1" max="22" inputmode="numeric">
                                ...
                                <div class="vd-guest-row">
                                    ...
                                    <div class="input-group guest-counter vd-counter" data-type="child">
                                        ...
                                        <input id="vdChildren" type="number" name="children" class="vd-counter-input" value="<?php echo e(request()->query('children', 0)); ?>" min="0" max="22" inputmode="numeric">
                                ...
                                <div class="vd-guest-row">
                                    ...
                                    <div class="input-group guest-counter vd-counter" data-type="infant">
                                        ...
                                        <input id="vdInfants" type="number" name="infants" class="vd-counter-input" value="<?php echo e(request()->query('infants', 0)); ?>" min="0" max="10" inputmode="numeric">
                                ...
                                <div class="vd-guest-row">
                                    ...
                                    <div class="input-group guest-counter vd-counter" data-type="pet">
                                        ...
                                        <input id="vdPets" type="number" name="pets" class="vd-counter-input" value="<?php echo e(request()->query('pets', 0)); ?>" min="0" max="5" inputmode="numeric">
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const checkInValue = "<?php echo e(request()->query('check_in')); ?>";
  const checkOutValue = "<?php echo e(request()->query('check_out')); ?>";
...
<?php /**PATH C:\xampp\htdocs\V18\resources\views/sections/booking-header.blade.php ENDPATH**/ ?>