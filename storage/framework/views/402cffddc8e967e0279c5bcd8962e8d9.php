                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="auth-right">
                                ...
                                <?php if(session('login_err')): ?>
                                    <div class="alert alert-danger rounded-3">
                                        <?php echo e(session('login_err')); ?>
                                ...
                                <?php if(session('google_error')): ?>
                                    <div class="alert alert-danger rounded-3">
                                        ...
                                        <?php if(session('google_suggest_create')): ?>
                                            <div class="mt-2 auth-links">
                                                <a href="<?php echo e(route('register', $redirect ? ['redirect' => $redirect] : [])); ?>">Create account</a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>

                                <?php if($errors->any() && !$errors->has('login_err')): ?>
                                    <div class="alert alert-danger rounded-3">
                                        <ul class="mb-0">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <a
                                        href="<?php echo e(route('auth.google.login', $redirect ? ['redirect' => $redirect] : [])); ?>"
                                    ...
                                    <p class="text-center mt-3 mb-0 auth-links">
                                        ...
                                        <a href="<?php echo e(route('register', $redirect ? ['redirect' => $redirect] : [])); ?>">Create one</a>
                                    </p>
                                </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\V18\resources\views/auth/login.blade.php ENDPATH**/ ?>