    ...
    <div id="header-carousel"
        ...
        <div class="carousel-inner">
            ...
            <?php $__currentLoopData = $carouselImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                    <img src="<?php echo e(asset('img/' . $image)); ?>" class="d-block w-100 carousel-img" alt="Image <?php echo e($index + 1); ?>">
                </div>
        ...
        <div class="vd-sticky-caption">
            <div class="vd-caption-inner text-center">
                ...
                <a class="btn btn-primary py-md-3 px-md-5" href="<?php echo e(route('rooms.index')); ?>">
                    Book A Room
                </a>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\V18\resources\views/sections/carousel.blade.php ENDPATH**/ ?>